...
-(void)setCateNo:(NSString *)cateNo
{
  if (![_cateNo isEqualToString:cateNo]) {
    ...
    CategoryUpdateData *updateData = [[[DataManager sharedDataManager] getCategoryUpdateDic] getCategoryUpdateById:categoryData.categoryUpdateId];
    _labCateType.string = updateData.categoryUpdateLabel;
