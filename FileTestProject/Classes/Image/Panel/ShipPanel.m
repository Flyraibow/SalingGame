...
-(instancetype)initWithDataList:(NSArray *)dataList
{
  if (self = [super init]) {
    ...
    if (_shipData == nil) {
      _shipData = [[[GameDataManager sharedGameData] shipDic] objectForKey:[[GameDataManager sharedGameData].myGuild.myTeam.shipList firstObject]];
    }
    NSAssert(_shipData != nil && [_shipData isKindOfClass:[GameShipData class]], @"ship data cannot be nil");
