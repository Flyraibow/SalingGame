...
static NSString* const GameShipCannonPower = @"GameShipCannonPower";
...
-(instancetype)initWithShipData:(ShipData *)shipData
{
    if (self = [super init]) {
        ...
        _cannonPower = shipData.cannonPower;
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        _cannonPower = [aDecoder decodeIntForKey:GameShipCannonPower];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeInt:_cannonPower forKey:GameShipCannonPower];
