...
-(instancetype)initWithNpcId:(NSString *)npcId
{
  if (self = [self init]) {
    ...
    _npcInfo = [[[DataManager sharedDataManager] getNpcInfoDic] getNpcInfoById:npcId];
    _npcId = npcId;
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder
{
  ...
  if (self) {
    ...
    _npcInfo = [[[DataManager sharedDataManager] getNpcInfoDic] getNpcInfoById:_npcId];
  }
  return self;
}
